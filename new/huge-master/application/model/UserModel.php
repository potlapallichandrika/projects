...
class UserModel
{
    ...
    public static function getPublicProfilesOfAllUsers()
    {
        ...
        $sql = "SELECT U.user_id, U.user_name, U.user_email, U.user_active, U.user_has_avatar,U.user_deleted, U.branch_id, B.branch_name FROM users U left join branches B on (U.branch_id = B.branch_id)";
        ...
        //print_r($all_users_profiles);
            ...
            $all_users_profiles[$user->user_id]->branch_id = $user->branch_id;
            $all_users_profiles[$user->user_id]->branch_name = $user->branch_name;
    ...
    public static function getPublicProfileOfUser($user_id)
    {
        ...
        $sql = "SELECT user_id, user_name, user_email, user_active, user_has_avatar, user_deleted, branch_id
...
public static function updateUserAvatarimage($userId)
{
    $database = DatabaseFactory::getFactory()->getConnection();

    $sql = "UPDATE users SET user_has_avatar = '1' WHERE user_id = :userId";
    $query = $database->prepare($sql);
...
public static function getBranches() 
{
    $database = DatabaseFactory::getFactory()->getConnection();
        ...
        foreach ($query->fetchAll() as $branch) {
            $all_branches[$branch->branch_id] = $branch->branch_name;
        }

    //     echo "SQL: " . $sql . "<br>";
    // echo "Number of branches: " . count($all_branches) . "<br>";
    // print_r($all_branches);
        return $all_branches;

}

public static function updateprofile($user_id, $user_name,  $branch_id)
{
    ...
    $sql = "UPDATE users SET user_name = :user_name, branch_id = :branch_id WHERE user_id = :user_id";
