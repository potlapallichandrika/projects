    ...
    <div class="wrapper">
        ...
        <ul class="navigation">
            ...
            <?php if (Session::userIsLoggedIn()) { ?>
                ...
                <li <?php if (View::checkForActiveController($filename, "branch")) { echo ' class="active" '; } ?> >
                    <a href="<?php echo Config::get('URL'); ?>branch/index">Branches</a>
                </li>
        ...
        <?php if (Session::userIsLoggedIn()) : ?>
            ...
            <?php if (Session::get("user_account_type") == 2) : ?>
                <li <?php if (View::checkForActiveController($filename, "Teacher")) {
                    echo ' class="active" ';
                } ?> >
                    <a href="<?php echo Config::get('URL'); ?>admin/">Teacher</a>
                </li>
            <?php endif; ?>
        <?php endif; ?>
        </ul>